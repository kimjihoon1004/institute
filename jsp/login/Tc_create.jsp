...
if(request.getMethod().equalsIgnoreCase("POST"))    {
    ...
    try {
    	...
    	if(subtype.equals("create"))   {
    		...
    		tc.setTc_name(request.getParameter("user_name"));
    		tc.setTc_mail(email);
    		tc.setTc_pw(request.getParameter("user_pw"));
    		tc.setTc_phone(request.getParameter("user_phone"));
    		tc.setTc_date(birth);
                ...
                <form name="create" onSubmit='return !!(value_check() & lastcheck(user_pw, user_pwcheck) & check_length(user_pw));' method="post">
                    ...
                    <table border="2" width="800" cellspacing="0" cellpadding="2">
                        ...
                        <tr>
                            ...
                            <td  width = "500">
                                <input type="text" name="user_id" size = "20" maxlength = "20" class = "input_style1" /> @
                    ...
                    <input type = "button" onclick="location.href='Tc_login.jsp'" value="뒤로가기">
                </form>
            </center>
        </fieldset>
    </body>
